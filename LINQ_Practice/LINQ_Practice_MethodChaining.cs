...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.PrimaryInstructor.FirstName == "Zachary" && c.PrimaryInstructor.LastName == "Zohan" || c.JuniorInstructors.Any(i => i.FirstName == "Zachary" && i.LastName == "Zohan")).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.FullTime == false && c.JuniorInstructors.All(i => i.Active == true) && c.PrimaryInstructor.Active == true).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.Students.Any(s => s.FirstName == "Kate") || c.PrimaryInstructor.FirstName == "Kate" || c.JuniorInstructors.Any(i => i.FirstName == "Kate")).ToList();
